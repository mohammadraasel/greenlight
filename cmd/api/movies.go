...
func (app *application) getMovies(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
...
func (app *application) updateMovie(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	id, err := app.readIDParam(params)
	if err != nil {
		app.notFoundResponse(w, r)
		return
...
func (app *application) deleteMovie(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	id, err := app.readIDParam(params)
	if err != nil {
		app.notFoundResponse(w, r)
		return
